...
const sheetVariants = cva(
  // `overflow-y-auto overscroll-contain` garante que a barra de rolagem
  // pertença ao próprio sheet — nunca ao fundo. `[-webkit-overflow-scrolling:touch]`
  // habilita momentum scrolling no iOS.
  "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out overflow-y-auto overscroll-contain [-webkit-overflow-scrolling:touch]",
  {
    variants: {
      side: {
